...
const services = [
  ...
  { number: "02", title: "Content Creation", desc: "High-quality reels, photography, product shoots, video editing, and script writing that capture attention and tell your story.", color: "bg-[#16B0C7]" },
  { number: "03", title: "Branding", desc: "Logo design, brand identity, guidelines, typography, color systems, and messaging that make your brand instantly recognizable.", color: "bg-[#134981]" },
  { number: "04", title: "Website Design", desc: "Business websites, landing pages, portfolio sites, and e-commerce experiences built for conversions and user delight.", color: "bg-[#16B0C7]" },
  { number: "05", title: "LinkedIn Personal Branding", desc: "Profile optimization, content strategy, post creation, and thought leadership development for professionals and executives.", color: "bg-[#134981]" },
  { number: "06", title: "Performance Marketing", desc: "Meta Ads, lead generation, conversion campaigns, and retargeting strategies that deliver measurable ROI.", color: "bg-[#16B0C7]" },
];
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden w-full">
        ...
        <div className="absolute inset-0 z-0 w-full h-full">
          ...
          />
          {/* Layered cinematic gradients for flawless contrast & readability */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0a0c12] via-[#0a0c12]/80 md:via-[#0a0c12]/50 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0a0c12] via-transparent to-black/40" />
        </div>

        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-32 sm:py-40">
          <Reveal preset="fade-up" duration={0.8} className="max-w-4xl">
            <span className="inline-flex items-center gap-2.5 text-[#16B0C7] text-xs font-semibold uppercase tracking-[0.25em] mb-6 px-4 py-2 rounded-full bg-[#16B0C7]/10 border border-[#16B0C7]/20 backdrop-blur-sm">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[84px] xl:text-[96px] font-bold text-white leading-[1.08] tracking-tight mb-8">
              ...
              <span className="whitespace-nowrap">
                at it&apos;s{" "}
                <span className="font-serif italic font-normal text-transparent bg-clip-text bg-gradient-to-r from-white via-[#b4eff7] to-[#16B0C7]">
                  Prime.
                </span>
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              <Link
                href="/contact"
                className="inline-block text-xs sm:text-sm font-semibold uppercase tracking-[2px] text-white bg-[#16B0C7] hover:bg-[#139bb0] px-8 py-4 sm:px-9 sm:py-4.5 transition-all shadow-lg shadow-[#16B0C7]/25 hover:shadow-xl hover:shadow-[#16B0C7]/40 hover:-translate-y-0.5"
              >
                Book a Discovery Call &rarr;
              </Link>
              <Link
                href="/portfolio"
                className="inline-block text-xs sm:text-sm font-semibold uppercase tracking-[2px] text-white/80 border border-white/30 hover:border-[#16B0C7] hover:text-white px-8 py-4 sm:px-9 sm:py-4.5 transition-all backdrop-blur-xs hover:bg-[#16B0C7]/10 hover:-translate-y-0.5"
              >
                View Our Work
              </Link>
            </div>
      ...
      {/* The Problem Section */}
      <section className="py-28 lg:py-36 bg-[#111319]">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <Reveal preset="slide-left" delay={0.1} className="max-w-lg">
              <ul className="space-y-6">
                {[
                  ...
                  <li key={item.problem} className="flex items-start gap-4">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#16B0C7] mt-2 shrink-0" />
                    <div>
      ...
      <section className="py-28 lg:py-36 bg-[#0a0d14]">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <Reveal preset="fade-up" className="text-center mb-16">
            <h6 className="text-[#16B0C7] text-[11px] uppercase tracking-[0.25em] font-semibold mb-6">
              OUR PHILOSOPHY
            </h6>
            <h2 className="text-4xl lg:text-[48px] font-bold text-white leading-[1.2] mb-6">
          ...
          <Reveal preset="fade-up" delay={0.15} className="max-w-4xl mx-auto text-center">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <StaggerContainer
            staggerDelay={0.08}
            className="flex overflow-x-auto md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 pb-4 md:pb-0 snap-x snap-mandatory brand-scrollbar"
          >
            {services.map((s) => (
              <StaggerItem
                key={s.number}
                className={`${s.color} p-8 lg:p-9 text-white group rounded-sm transition-transform duration-300 hover:-translate-y-1 w-[280px] sm:w-[320px] md:w-auto shrink-0 snap-center flex flex-col justify-between`}
              >
                <div>
                ...
                <Link href="/services" className="text-white/90 text-sm font-medium uppercase tracking-wider hover:text-white transition-colors block mt-4">
                  Read More &rarr;
                </Link>
              </StaggerItem>
            ))}
          ...
          <div className="md:hidden flex items-center justify-center gap-2 mt-4 text-xs text-white/40 tracking-wider">
            <span className="text-[#16B0C7]">←</span> Swipe to explore all services <span className="text-[#16B0C7]">→</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            {testimonials.map((t) => (
              <StaggerItem
                key={t.name}
                className="bg-[#0b0d12] p-8 rounded-lg border border-white/5 hover:border-[#16B0C7]/30 transition-all w-[280px] sm:w-[320px] md:w-auto shrink-0 snap-center flex flex-col justify-between"
              >
                <div>
      ...
      {/* Our Clients Section */}
      <section className="py-24 lg:py-32 bg-[#090b10] overflow-hidden relative border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-16 text-center">
          <Reveal preset="fade-up">
            <h6 className="text-[#16B0C7] text-[11px] uppercase tracking-[0.25em] font-semibold mb-4">
              TRUSTED PARTNERS
            </h6>
        ...
        {/* Logo Grid container with clean cards and mobile horizontal scroll */}
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <StaggerContainer
            staggerDelay={0.04}
            className="flex overflow-x-auto md:grid md:grid-cols-4 gap-4 md:gap-6 pb-4 md:pb-0 px-2 md:px-0 snap-x snap-mandatory brand-scrollbar"
          >
            {clientLogos.map((logo) => (
              <StaggerItem
                key={logo.src}
                className="group relative w-[200px] sm:w-[230px] md:w-auto shrink-0 snap-center h-36 sm:h-40 md:h-44 bg-[#111319]/80 rounded-2xl border border-white/5 hover:border-[#16B0C7]/40 flex items-center justify-center p-5 md:p-6 transition-all duration-300 hover:bg-[#141720] hover:-translate-y-1"
              >
                <img
                  src={logo.src}
                  alt={logo.alt}
                  className="max-h-16 sm:max-h-20 md:max-h-24 w-auto max-w-[140px] sm:max-w-[160px] md:max-w-[180px] object-contain opacity-75 grayscale filter group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-300 select-none pointer-events-none"
                />
              </StaggerItem>
            ))}
            {/* 12th card for visual balance */}
            <StaggerItem className="group relative w-[200px] sm:w-[230px] md:w-auto shrink-0 snap-center h-36 sm:h-40 md:h-44 bg-[#111319]/40 rounded-2xl border border-dashed border-[#16B0C7]/30 flex flex-col items-center justify-center p-5 md:p-6 text-center hover:border-[#16B0C7] transition-colors">
              <span className="text-[#16B0C7] font-bold text-lg md:text-xl mb-1 md:mb-2">+ Your Brand</span>
          ...
          {/* Mobile Swipe Hint */}
          <div className="md:hidden flex items-center justify-center gap-2 mt-4 text-xs text-white/40 tracking-wider">
            <span className="text-[#16B0C7]">←</span> Swipe to explore all partners <span className="text-[#16B0C7]">→</span>
          </div>
        </div>
      </section>
      ...
      <section className="w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
          ...
          {/* CTA Box with Navy to Cyan Gradient */}
          <div className="aspect-square bg-gradient-to-br from-[#134981] to-[#16B0C7] flex flex-col items-center justify-center p-8 text-center">
            <h3 className="text-3xl lg:text-4xl font-bold text-white leading-tight mb-8">
              Next Project Will<br />Be Yours
            </h3>
            <Link
              href="/contact"
              className="inline-block text-[12px] font-bold uppercase tracking-[0.2em] text-white border border-white px-8 py-4 hover:bg-white hover:text-[#134981] transition-colors"
            >
              GET STARTED NOW
            </Link>
          </div>
